...
import 'package:sakni/views/password_after_vertification_page.dart';
import 'package:sakni/widgets/custom_text_home.dart';

class CodeVertificationPage extends StatefulWidget {
  const CodeVertificationPage({super.key});

  @override
  State<CodeVertificationPage> createState() => _CodeVertificationPageState();
}

class _CodeVertificationPageState extends State<CodeVertificationPage> {
  Timer? _timer;
  int _seconds = 120;
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      body: Stack(
        children: [
          CustomTextHome(
            title: 'تأكيد رمز انشاء الحساب',
            subTitle:
                'ادخل الكود الذى تم ارساله اليك لتأكيد عمليه انشاء الحساب الخاص بك',
          ),
                    ...
                    CustomButton(
                      onTap: () {
                        ...
                        Navigator.push(
                          ...
                          MaterialPageRoute(
                            builder: (context) {
                              return PasswordAfterVertificationPage();
                            },
                          ),
                        );
                      },
                        ...
                        children: [
                          ...
                          Text(
                           ...
                           if (!_isTimerFinished)
                            Text(
                              '($timerText)',
                              style: const TextStyle(color: Color(0xffFF4947)),
                            ),
                        ],
                      ),
                    ),
